package cloudsim.sdn.graph.example;
...
import cloudsim.sdn.Activity;
import cloudsim.sdn.Processing;
import cloudsim.sdn.Request;
import cloudsim.sdn.SDNDatacenter;
import cloudsim.sdn.Transmission;
import cloudsim.sdn.example.SDNBroker;
import cloudsim.sdn.example.SimpleNetworkOperatingSystem;
import cloudsim.sdn.example.VmAllocationPolicyCombinedLeastFullFirst;
import cloudsim.sdn.example.Workload;
import cloudsim.sdn.example.VmSchedulerSpaceSharedEnergy;
...
public class GraphicSDNExample {
	...
	private void printHostUtilizationHistory(
			List<cloudsim.sdn.example.VmSchedulerSpaceSharedEnergy.HistoryEntry> utilizationHisotry) {
		for(cloudsim.sdn.example.VmSchedulerSpaceSharedEnergy.HistoryEntry h:utilizationHisotry) {
