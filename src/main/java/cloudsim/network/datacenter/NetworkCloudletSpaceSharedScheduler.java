...
public class NetworkCloudletSpaceSharedScheduler extends CloudletScheduler {
	...
	/*
	 * (non-Javadoc)
	 * @see cloudsim.CloudletScheduler# getTotalCurrentAvailableMipsForCloudlet
	...
	/*
	 * (non-Javadoc)
	 * @see cloudsim.CloudletScheduler# getTotalCurrentAllocatedMipsForCloudlet
	...
	/*
	 * (non-Javadoc)
	 * @see cloudsim.CloudletScheduler# getTotalCurrentRequestedMipsForCloudlet
	 * (cloudsim.ResCloudlet, double)
	 */
	@Override
