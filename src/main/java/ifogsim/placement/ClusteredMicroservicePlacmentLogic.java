...
import ifogsim.entities.ControllerComponent;
import ifogsim.entities.FogDevice;
import ifogsim.entities.MicroserviceFogDevice;
...
public class ClusteredMicroservicePlacmentLogic implements  MicroservicePlacementLogic {
    /**
    ...
    Map<Integer, Map<String, Integer>> mappedMicroservices = new HashMap<>();//mappedMicroservice

    public ClusteredMicroservicePlacmentLogic(int fonID) {
        setFONId(fonID);
    }
